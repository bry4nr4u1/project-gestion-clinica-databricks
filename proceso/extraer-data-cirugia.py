...
dbutils.widgets.text("raw_file", "cirugia.csv")
...
dbutils.widgets.text("bronze_table", "cirugia")
...
# Definir el esquema del CSV cirugia
cirugias_schema = StructType([
    StructField("codigo_cirugia", StringType(), False),
    StructField("nombre_cirugia", StringType(), True),
    StructField("especialidad", StringType(), True),
    StructField("duracion_promedio_minutos", IntegerType(), True),
    StructField("complejidad", StringType(), True),
    StructField("costo_base", IntegerType(), True),
    StructField("riesgo_nivel", StringType(), True),
...
df_raw = spark.read.option("header", "true").schema(cirugias_schema).csv(csv_path)
